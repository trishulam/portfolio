...
export function Hero() {
  return (
    <section id="top" className="shell grid gap-12 pt-16 pb-14 sm:pt-24 sm:pb-16 lg:grid-cols-[minmax(0,1.55fr)_minmax(0,1fr)] lg:items-end lg:gap-16">
      ...
      <dl className="cells grid-cols-2">
        {stats.map((s) => (
